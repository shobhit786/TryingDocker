...
SECRET_KEY = 'django-insecure-h7p6$=&nu*hw&@j!zu9)7wniqto&*&c9uj#s&32u$*3i9ep!nr'
...
SWAGGER_SETTINGS = {
    'USE_SESSION_AUTH': False,  # Set to True if you want to use session-based authentication
